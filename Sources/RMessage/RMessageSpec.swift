...
public extension RMessage {
    enum Specs {
        public static var errorSpec: RMessageSpec {
            var errorSpec = DefaultRMessageSpec()
            errorSpec.backgroundColor = .systemRed
        ...
        public static var warningSpec: RMessageSpec {
            var warningSpec = DefaultRMessageSpec()
            warningSpec.backgroundColor = .systemYellow
            warningSpec.titleColor = .secondaryLabel
        ...
        public static var normalSpec: RMessageSpec {
            var normalSpec = DefaultRMessageSpec()
            normalSpec.backgroundColor = .secondarySystemGroupedBackground
            normalSpec.titleColor = .secondaryLabel
            normalSpec.bodyColor = normalSpec.titleColor
            return normalSpec
        }
        
        public static var successSpec: RMessageSpec {
            var successSpec = DefaultRMessageSpec()
            successSpec.backgroundColor = .systemGreen
