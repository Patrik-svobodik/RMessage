...
public class RMController: NSObject, RMPresenterDelegate {
    ...
    public func showMessage(
        withSpec spec: RMessageSpec = RMessage.Specs.normalSpec,
        atPosition targetPosition: RMessagePosition = .top,
        title: String,
        body: String? = nil,
        ...
        guard let presentationVC = presentVC else { return }
     ...
     */
    public func dismissOnScreenMessage(withCompletion completion: (() -> ())? = nil) -> Bool {
